...
public interface UserService {
    User updateProfile(Long userId, String nickname, Integer dailyWordTarget);
    ...
    UserWordProgress markWordKnown(Long userId, Long wordId);
    UserWordProgress resetWordProgress(Long userId, Long wordId);
    List<UserWordProgress> getReviewWords(Long userId);
}
